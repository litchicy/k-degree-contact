...
//                + infectiousSourceID.toString() + "_k=" + degree + "_d=" + thresholdOfDistance + "_w=" + widthOfSlidingWindow + ".txt";
        ...
        rTrees[1500].visualize(600,600)
                .save("C:\\Users\\Administrator\\Desktop\\TDrivemytree0.png");
        rTrees[1600].visualize(600,600)
                .save("C:\\Users\\Administrator\\Desktop\\TDrivemytree1.png");
